  ...
  return (
    <div className='flex flex-col items-start md:items-center gap-y-5 md:gap-y-0'>
        ...
        <p className='text-sm md:text-center text-left text-muted-foreground'>
            Grouple is a vibrant online community platform that empowers <br className='md:hidden' /> people to connect , <br className='hidden md:block' /> collaborate, and cultivate meaningful <br className='md:hidden' /> relationships
        </p>
