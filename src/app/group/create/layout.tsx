    ...
    <div className='container h-screen grid grid-cols-1 lg:grid-cols-2 content-center'>
        <div className='flex items-center'>
            <BackdropGradient className='w-8/12 h-2/6 opacity-50'>
                ...
                <p className='text-themeTextGray'>Free for 14 days, then $99/month. Cancel anytime.All features.Unlimited everything. No hidden fees</p>
        ...
        <BackdropGradient className='w-6/12 h-3/6 opacity-40' container='lg:items-center'>
